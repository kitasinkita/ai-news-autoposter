...
class AINewsAutoPoster {
    ...
    private function build_direct_article_prompt($settings) {
        ...
        $prompt .= "...\n\n";
        $prompt .= "## 参考情報源\n";
        $prompt .= "[参考にした情報源を以下の形式で記載してください]\n";
        $prompt .= "[形式: 「記事タイトル」(発行日) - メディア名 ※Google検索: \"記事タイトル メディア名\"で検索可能]\n";
        $prompt .= "[例: 「ChatGPT-4の新機能発表」(2024年1月10日) - 日経新聞 ※Google検索: \"ChatGPT-4の新機能発表 日経新聞\"]\n\n";
