...
// プラグインの基本定数
define('AI_NEWS_AUTOPOSTER_VERSION', '1.1.2');
...
class AINewsAutoPoster {
                ...
                <table class="ai-news-form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="ai-news-form-description">使用するAIモデルを選択してください。Geminiモデルは2024年末までの最新知識を活用しますが、高コストです（1,000クエリ$35）。</p>
                        </td>
                    </tr>
    ...
    private function call_gemini_api($prompt, $api_key, $model = 'gemini-1.5-flash') {
        ...
        $body = array(
            ...
            // Google Search Grounding - 一旦無効化（技術的問題のため）
            // 'tools' => array(
            //     array(
            //         'googleSearch' => array()
            //     )
